      ...
      <div className="flex justify-between px-10 py-4 items-center">
        ...
        <div className=" flex  justify-items-end">
          <div className="flex gap-[15px] mr-[20px] ">
            <div
              className={` w-[42px] h-[42px] rounded-[124px]  border-[1px]  flex items-center justify-center ${
                isSticky ? "border-[#AFCD80]" : "border-[#ffffff] "
              } ${isSticky ? "bg-[#ffffff]" : " bg-[#2042B6]"}`}
            >
              {isSticky ? (
                <Image
            ...
            <div
              className={`w-[250px] h-[42px] rounded-[124px]  border-[1px]   flex items-center justify-center ${
                isSticky ? "text-[#191618]" : "text-[#ffffff]"
              }  ${isSticky ? "bg-[#ffffff]" : " bg-[#2042B6] "} ${
                isSticky ? "border-[#2042B6] " : "border-[#ffffff]"
              }`}
            >
