...
const Footer = () => (
    <footer className="bg-li-gray  p-5 text-center text-light">
     ...
     <section>
        <div className=" flex mb-[10px] p-[5px]">
            <div className="w-[454px] h-[196] ">
                <p className=" font-nantes text-[36px] text-left leading-[48.96px]" >
                    ...
                    {/* nav section */}
            <nav className="flex flex-col mx-auto w-[84px] h-[230px] text-[20px] leading-[30px] text-left text-r-blue font-messina">
                <p className="text-dk-gray ">Jump to</p>
                <a href="#" className="mx-2 text-light mb-[10px]">AboutUs</a>
                <a href="#" className="mx-2 text-light mb-[10px]">Portfolio</a>
                <a href="#" className="mx-2 text-light mb-[10px]">News</a>
                <a href="#" className="mx-2 text-light mb-[10px]">Stories</a>
                <a href="#" className="mx-2 text-light mb-[10px]">Jobs</a>
                <a href="#" className="mx-2 text-light">AboutUs</a>
            </nav>
            <div className="grid grid-flow-row font-messina text-[20px] mr-[30px]">
                <div>
                    <p className="text-left mb-[20px]">
                    <span className="font-bold">Cambridge </span><br/>
                     70728 Yost Burg, <br/>North Magdaleneview, <br/> UT 97952-2814
                </p>
                <hr className="w-[258px] h-[2px] bg-dk-gray mb-[20px]"/>
                
                </div>

                <div>
                    <p className="text-left mb-[20px]">
                        <span className="font-bold">London</span> <br/>
                ...
                <div>
                    <p className="text-left mb-[20px]">
                        <span className="font-bold">San Francisco</span> <br/>
                        19837 Gilberto Lodge,<br/> Lake  Kendallville,<br/> Colorado - 97392, Bhutan
                    </p>
                    <hr className="w-[258px] h-[2px] bg-dk-gray"/>
                </div>
            </div>
        </div>

        <div>
            <p className="flex space-x-10 text-center text-dk-gray mb-[10px]"><span>&copy;2024 </span>  <span>Terms of Use</span> <span>Privacy Policy</span>   </p>
        </div>   
        <div className=" grid grid-flow-col">
            <div className=" w-[517px] h-[105px] text-justify font-messina text-[14px]">
